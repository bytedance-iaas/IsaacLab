...
# rsl-rl >= 4.0 changed the config schema; this shim migrates the old-style
# agent cfg (monolithic ActorCritic) to the new actor/critic format at runtime.
_installed_rsl_rl_version = _metadata.version("rsl-rl-lib")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    # handle deprecated configurations (migrate old-style cfg for rsl-rl >= 4.0)
