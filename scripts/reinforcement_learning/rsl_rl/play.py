...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    if agent_cfg.class_name == "OnPolicyRunner":
        ...
        # Mirrors train.py. The runner exposes the same load / get_inference_policy / export_* API as
        # the on-policy one, so everything downstream of here works unchanged.
